...
// storage. If the retryable error doesn't provide a delay, exponential backoff is applied.
type Config struct {
	...
	// a downstream storage. Once this value is reached, the data is discarded. It never stops if MaxElapsedTime == 0.
